...
## Legal basis chain (one breath)
University = controller (supervisor signs as project responsible) → **Art. 6(1)(e)** public-interest research = general basis → **Art. 9(2)(j) + DBL §10** = special-category key, consent NOT required for research → SUBJECTs consent anyway (Art. 6(1)(a)/9(2)(a), donation + surveys) → OTHERs + mentioned persons: **Art. 14(5)(b)** exempts individual notice → **Art. 21(6)/17** objection = ongoing right → erasure, no pre-processing window → **Art. 89(1)** safeguards = the condition we fulfill.

## Art. 14(5)(b) package (present as ONE combined claim)
Two independent limbs; claim both + "in particular for research" phrase = legislator intent.

**Impossibility / disproportionate effort limb**
- No delivery channel: no API for personal FB Messenger/IG/WA; donor = only conduit
- n donors × 10²–10³ contacts, manual outreach
- Effort falls on donors (time + social/reputational cost) → cohort unobtainable → **document recruitment friction** (dated, quantified — even our own friends balk; strongest exhibit)

**Serious impairment of objectives limb**
- Notice + ex-ante objection breaks corpus↔survey timing sync (core validity)
- Selection bias: consenting/objecting friends ≠ representative sample
- Consent-all regime self-defeats → exemption exists precisely for this

**Near-zero harm (impact side of balancing)**
- OTHERs not unit of analysis; msgs only retrieval context for imitating SUBJECT
